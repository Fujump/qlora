...
# from pytorch_lightning.core.module import TrainResult,EvalResult
...
class MCQAModel(pl.LightningModule):
  ...
  def validation_step(self, batch, batch_idx):
    ...
    self.log('logits', logits, on_epoch=True, prog_bar=True)
    self.log('labels', labels, on_epoch=True, prog_bar=True)
